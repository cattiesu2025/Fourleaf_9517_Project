...
Usage:
    ...
    # Compare any two runs, including separately named ablations:
    ./scripts/comp9517 transfer-gradcam-compare --image-id 50 \
        --dir-a outputs/transfer/resnet18_pretrained_frozen --label-a Frozen \
        --dir-b outputs/transfer/resnet18_pretrained_finetuned --label-b Finetuned
"""
...
def main():
    ...
    parser.add_argument(
        "--out_file", default="outputs/transfer/gradcam_frozen_vs_finetuned_example.png"
    )
    ...
    for ax, out_dir, label in [
        (axes[1], args.dir_a, args.label_a),
